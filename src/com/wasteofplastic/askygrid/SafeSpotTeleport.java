...
public class SafeSpotTeleport {
     ...
     */
    public SafeSpotTeleport(final ASkyGrid plugin, final Entity player, final Location l, final String failureMessage) {
     ...
     * @param l
     */
    public SafeSpotTeleport(final ASkyGrid plugin, final Entity player, final Location l) {
     ...
     * @param islandLoc
     */
    public SafeSpotTeleport(final ASkyGrid plugin, final Entity entity, final Location islandLoc, final int homeNumber, final String failureMessage, final boolean setHome) {
	this.plugin = plugin;
	if (true) {
