 ...
 */
package com.wasteofplastic.askygrid.util;
...
public class VaultHelper {
	...
	RegisteredServiceProvider<Economy> economyProvider = ASkyGrid.getPlugin().getServer().getServicesManager()
	...
	RegisteredServiceProvider<Permission> permissionProvider = ASkyGrid.getPlugin().getServer().getServicesManager()
